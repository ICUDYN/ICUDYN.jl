function Scheduler.checkIfAnythingNeedsToBeExecuted()
    ...
    for f in functions
        Scheduler.checkIfNeedsToExecuteFunction(
            f._module,
            f._functionName,
            f._execution_times
        )
...
function Scheduler.checkIfNeedsToExecuteFunction(_module::Module,
      ...
      for _time in _execution_times
            ...
            lastExecution = MedilegistUtil.createDBConnAndExecute() do dbconn
            ...
            MedilegistUtil.createDBConnAndExecute() do dbconn
            ...
            # Execute the function on one of the available process
            @spawnat :any fct()
