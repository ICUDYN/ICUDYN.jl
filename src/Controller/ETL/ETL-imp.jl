...
function ETL.refineWindow2ndPass!(
    ...
    # Useful variables
    unplugAttemptInvasiveVentilation = ETL.getCachedVariable(
        cache,
    ...
    # Compute ventilation types and debit O2
    fctResult = passmissing(ETL.Ventilation.computeVentilationTypeAndDebitO2)(
        rawWindow,
        unplugAttemptInvasiveVentilation
    )
    ETL.enrichWindowModulesResultsWith2ndPassFunctionResult!(
